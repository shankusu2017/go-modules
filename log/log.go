...
// https://github.com/go-fastlog/fastlog/blob/master/README_zh.md
...
func (l *Logger) Printf(format string, v ...interface{}) {
	l.Output(callDep, Linfo, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Fatal(v ...interface{}) {
	l.Output(callDep, Lerror, fmt.Sprint(v...))
	os.Exit(1)
}

// Fatalf is equivalent to l.Printf() followed by a call to os.Exit(1).
func (l *Logger) Fatalf(format string, v ...interface{}) {
	l.Output(callDep, Lerror, fmt.Sprintf(format, v...))
	os.Exit(1)
}

// Fatalln is equivalent to l.Println() followed by a call to os.Exit(1).
func (l *Logger) Fatalln(v ...interface{}) {
	l.Output(callDep, Lerror, fmt.Sprintln(v...))
	os.Exit(1)
}
...
// SetFile sets the output flags for the logger.
func (l *Logger) SetFile(fd io.Writer) {
	l.mu.Lock()
	defer l.mu.Unlock()
	l.out = fd
}
...
func Print(v ...interface{}) {
	std.Output(callDep, Linfo, fmt.Sprint(v...))
}

// Printf calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Printf(format string, v ...interface{}) {
	std.Output(callDep, Linfo, fmt.Sprintf(format, v...))
}

// Println calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Println.
func Println(v ...interface{}) {
	std.Output(callDep, Linfo, fmt.Sprintln(v...))
}

// Fatal is equivalent to Print() followed by a call to os.Exit(1).
func Fatal(v ...interface{}) {
	std.Output(callDep, Lerror, fmt.Sprint(v...))
	os.Exit(1)
}

// Fatalf is equivalent to Printf() followed by a call to os.Exit(1).
func Fatalf(format string, v ...interface{}) {
	std.Output(callDep, Lerror, fmt.Sprintf(format, v...))
	os.Exit(1)
}

// Fatalln is equivalent to Println() followed by a call to os.Exit(1).
func Fatalln(v ...interface{}) {
	std.Output(callDep, Lerror, fmt.Sprintln(v...))
	os.Exit(1)
}
...
func (l *Logger) Trace(v ...interface{}) {
	l.Output(callDep, Ltrace, fmt.Sprint(v...))
}

// Tracef calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func (l *Logger) Tracef(format string, v ...interface{}) {
	l.Output(callDep, Ltrace, fmt.Sprintf(format, v...))
}

// Traceln calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func (l *Logger) Traceln(v ...interface{}) {
	l.Output(callDep, Ltrace, fmt.Sprintln(v...))
}

// Debug calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Debug(v ...interface{}) {
	std.Output(callDep, Ldebug, fmt.Sprint(v...))
}

// Debugf calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Debugf(format string, v ...interface{}) {
	std.Output(callDep, Ldebug, fmt.Sprintf(format, v...))
}

// Debugln calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Debugln(v ...interface{}) {
	std.Output(callDep, Ldebug, fmt.Sprintln(v...))
}
...
func Warn(v ...interface{}) {
	std.Output(callDep, Lwarn, fmt.Sprint(v...))
}

// Warnf calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Warnf(format string, v ...interface{}) {
	std.Output(callDep, Lwarn, fmt.Sprintf(format, v...))
}

// Warnln calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Warnln(v ...interface{}) {
	std.Output(callDep, Lwarn, fmt.Sprintln(v...))
}
...
func Trace(v ...interface{}) {
	std.Output(callDep, Ltrace, fmt.Sprint(v...))
}

// Tracef calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Tracef(format string, v ...interface{}) {
	std.Output(callDep, Ltrace, fmt.Sprintf(format, v...))
}

// Traceln calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Traceln(v ...interface{}) {
	std.Output(callDep, Ltrace, fmt.Sprintln(v...))
}

// Panic is equivalent to Print() followed by a call to panic().
func Panic(v ...interface{}) {
	s := fmt.Sprint(v...)
	std.Output(callDep, Lpanic, s)
	panic(s)
}
